...
const UNITED_TICKET_GROUPINGS = Object.freeze(['OPERACION', 'PORTAFOLIO', 'EXPERIMENTAL']);

const TICKET_LIST_PERMISSIONS = Object.freeze([
...
const TICKET_DETAIL_PERMISSIONS = Object.freeze([
...
const ticketListGuard = humanInformationGuard_gnral({
  permissionCodesAny: TICKET_LIST_PERMISSIONS,
  domain: 'UNITED',
  groupingCodesAny: UNITED_TICKET_GROUPINGS
});

const ticketDetailGuard = humanInformationGuard_gnral({
  permissionCodesAny: TICKET_DETAIL_PERMISSIONS,
  domain: 'UNITED',
  groupingCodesAny: UNITED_TICKET_GROUPINGS
});
