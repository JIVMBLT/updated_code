...
router.post('/redes/importar-backup', requireAuth, requireHistoricalSyncEnabled, controller.syncRecords);
router.post('/redes/comentarios/importar-backup', requireAuth, requireHistoricalSyncEnabled, controller.syncComments);
