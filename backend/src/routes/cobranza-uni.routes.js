...
const cobranzaUniCuartosController = require('../controllers/cobranza-uni-cuartos.controller');
...
const gestionCreditoGuard = cobranzaUniGuard(
  'COBRANZA_UNI_ESTADOS_CUENTA_ACCESO_VISUAL_MODULO.ACCESO_VISUAL'
);
const ventaAdicionalGuard = cobranzaUniGuard(
...
router.get(
  '/gestion-credito',
  ...gestionCreditoGuard,
  cobranzaUniCuartosController.getGestionCredito
);
router.get(
  '/gestion-credito/:id/detalle',
  ...gestionCreditoGuard,
  cobranzaUniCuartosController.getGestionCreditoDetalle
);
router.get(
  '/venta-adicional',
  ...ventaAdicionalGuard,
  cobranzaUniCuartosController.getVentaAdicional
);
router.get(
  '/venta-adicional/:id/detalle',
  ...ventaAdicionalGuard,
  cobranzaUniCuartosController.getVentaAdicionalDetalle
);
